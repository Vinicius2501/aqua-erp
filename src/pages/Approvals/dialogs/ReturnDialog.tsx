      ...
      <DialogContent className="bg-card border-border w-full max-w-[calc(100vw-2rem)] sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-text-primary">
            {t('approvals.returnPO')}
          </DialogTitle>
          <DialogDescription className="text-text-secondary wrap-break-word">
            {t('approvals.returnMessage')} {selectedPO?.externalId}{' '}
            {t('approvals.informCorrections')}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4 overflow-hidden min-w-0">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="reason"
              placeholder={t('approvals.returnPlaceholder')}
              value={reason}
        ...
        <DialogFooter className="gap-3">
          ...
          <Button
            ...
            className="bg-amber-500 hover:bg-amber-600 disabled:bg-amber-300 text-white disabled:text-white/70"
          >
